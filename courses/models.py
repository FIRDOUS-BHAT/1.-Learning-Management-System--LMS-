...
class Course(models.Model):
    ...
    instructor = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, limit_choices_to={'role': 'instructor'},  null=True, blank=True)
...
class Enrollment(models.Model):
    ...
    # The class Meta defines a unique constraint that requires the combination of student and course
    # fields to be unique.
    class Meta:
